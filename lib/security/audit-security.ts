...
// Meeting security events
export const SEC_MEETING_BOOKED = "SEC_MEETING_BOOKED";
export const SEC_MEETING_CANCELLED = "SEC_MEETING_CANCELLED";
export const SEC_MEETING_RESCHEDULED = "SEC_MEETING_RESCHEDULED";
export const SEC_MEETING_TYPE_CREATED = "SEC_MEETING_TYPE_CREATED";
export const SEC_MEETING_TYPE_DELETED = "SEC_MEETING_TYPE_DELETED";

// Nurture security events
export const SEC_NURTURE_CAMPAIGN_SENT = "SEC_NURTURE_CAMPAIGN_SENT";
export const SEC_NURTURE_BULK_IMPORT = "SEC_NURTURE_BULK_IMPORT";
export const SEC_NURTURE_WEBHOOK_RECEIVED = "SEC_NURTURE_WEBHOOK_RECEIVED";
export const SEC_NURTURE_CONFIG_CHANGED = "SEC_NURTURE_CONFIG_CHANGED";
export const SEC_NURTURE_BULK_DELETE = "SEC_NURTURE_BULK_DELETE";
