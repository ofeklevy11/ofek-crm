    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        ...
        <div className="text-center mb-16 relative">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-slate-900 via-indigo-900 to-slate-900 mb-6 tracking-tight animate-fade-in-up animation-delay-100">
            Nurture Hub
          </h1>
