...
type NurtureSlug = "birthday" | "renewal" | "winback" | "review" | "upsell" | "referral" | "vip";
...
const TRIGGER_DATA: Record<NurtureSlug, {
  ...
  upsell: {
    ...
    icon: Zap,
    body: "ההודעות מופעלות באמצעות Webhook ממערכות חיצוניות (למשל לאחר רכישה) או חוקי אוטומציה עם autoTrigger. לאחר הפעלת הטריגר, ההודעה נשלחת בהתאם להשהייה שהוגדרה בסעיף \"תזמון שליחה\".",
    bullets: [
      "Webhook: בקשת POST אל /api/nurture/webhook/upsell עם Bearer token",
      "חוקי אוטומציה עם autoTrigger",
