...
import { X, Table as TableIcon, Loader2 } from "lucide-react";
...
export default function TableWidget({
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`relative rounded-2xl shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col justify-between aspect-square border border-indigo-100 bg-gradient-to-br from-indigo-50/80 via-white to-blue-50/80 group overflow-hidden cursor-grab active:cursor-grabbing`}
    >
      ...
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div className="flex-1">
          ...
          <h3
            className="text-lg font-semibold text-gray-900 line-clamp-2 min-h-[3.5rem]"
            title={title}
          >
            {title}
          </h3>
