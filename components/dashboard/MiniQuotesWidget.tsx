...
function MiniQuotesWidget({
  ...
  return (
    ...
    >
      <div className="h-1.5 w-full bg-linear-to-r from-indigo-400 to-violet-500" aria-hidden="true" />
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-start gap-1">
            <button
              ...
              aria-label="גרור ווידג׳ט: הצעות מחיר אחרונות"
          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
            {onOpenSettings && (
              <button
                className="p-1.5 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-md transition focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
                onClick={(e) => {
                  e.stopPropagation();
                  onOpenSettings(id);
                }}
