...
export default function GoalsTableWidget({
  ...
  return (
    ...
    >
      ...
      <div className="h-1.5 w-full bg-linear-to-r from-[#4f95ff] to-[#a24ec1]" />
        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border bg-purple-50 text-purple-700 border-purple-100">
                יעדים
              </span>
            </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-right text-sm text-gray-500 border-b border-gray-100">
                  <th className="pb-3 font-medium">שם היעד</th>
                  <th className="pb-3 font-medium w-24 text-center">סטטוס</th>
                  <th className="pb-3 font-medium w-32 text-center">התקדמות</th>
                  <th className="pb-3 font-medium text-center">נוכחי / יעד</th>
                  <th className="pb-3 font-medium text-center">סיום</th>
                </tr>
              </thead>
